...
workflow RUN {
    ...
    def custom_config = params.custom_config ? Channel.fromPath(params.custom_config).first() : Channel.fromPath("${workflow.projectDir}/bin/empty.txt").first() // need to pass a dummy file in the projectDir or similar
